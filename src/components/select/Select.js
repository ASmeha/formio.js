...
export default class SelectComponent extends BaseComponent {
  ...
  constructor(component, options, data) {
    ...
    // Trigger an update.
    this.triggerUpdate = _.debounce(this.updateItems.bind(this), 500);
  ...
  loadItems(url, search, headers, options, method, body) {
    ...
    if (this.previousSearch !== undefined && this.previousSearch !== '' && search === undefined) {
      this.loadedItems = 0;
      this.previousSearch = '';
    }
    else {
